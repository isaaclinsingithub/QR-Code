...
CREATE TABLE `item` (
  ...
  UNIQUE KEY `IDFSshelf_UNIQUE` (`IDFSshelf`),
  UNIQUE KEY `IDFSqr_UNIQUE` (`IDFSqrcode`),
  CONSTRAINT `IDFSqr` FOREIGN KEY (`IDFSqrcode`) REFERENCES `qrcode` (`IDqrcode`),
  CONSTRAINT `IDFSshelf` FOREIGN KEY (`IDFSshelf`) REFERENCES `shelf` (`IDshelf`)
...
INSERT INTO `item` VALUES (3,'BMX 3',0,300,0);
...
INSERT INTO `shelf` VALUES (0,'Bikes'),(1,'Headphones');
...
-- Dump completed on 2023-03-10  9:08:48
-- MySQL dump 10.13  Distrib 8.0.32, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: lehrlingsprojekt
-- ------------------------------------------------------
-- Server version	8.0.32
...
CREATE TABLE `albumsong` (
  ...
  `IDSong` int NOT NULL,
  `IDAlbumsong` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`IDAlbumsong`),
  UNIQUE KEY `IDAlbumsong_UNIQUE` (`IDAlbumsong`),
  KEY `IDSong_idx` (`IDSong`),
  KEY `IDAlbum_idx` (`IDAlbum`),
  CONSTRAINT `IDAlbum` FOREIGN KEY (`IDAlbum`) REFERENCES `album` (`IDAlbum`),
  CONSTRAINT `IDFSSong` FOREIGN KEY (`IDSong`) REFERENCES `song` (`IDSong`)
...
INSERT INTO `artist` VALUES (0,'starship','1984-01-01','American rock band known for hits like \"We Built This City\". No specific birth dates available.'),(1,'soft cell','1978-01-01','Comprising Marc Almond and David Ball. '),(2,'The Main Ingredient ','1964-01-01','American soul and R&B group known for hits like \"Everybody Plays the Fool\".'),(3,'lynyrd skynyrd ','1964-01-01','American rock band known for hits like \"Free Bird\".'),(4,'acdc','1973-01-01','Australian rock band known for hits like \"Highway to Hell\".'),(5,'elton john ','1967-01-01','English singer-songwriter and pianist known as one of the most successful and influential artists of all time.'),(6,'wolfmother','2000-01-01','Australian hard rock band known for hits like \"Joker and the Thief\".'),(7,'van halen ','1972-01-01','American rock band known for hits like \"Jump\" and led by guitarist Eddie Van Halen.'),(8,'electric light orchestra ','1970-01-01','British rock band known for hits like \"Mr. Blue Sky\".'),(9,'bruno mars ','2004-01-01','American singer-songwriter known for hits like \"Runaway Baby\".'),(10,'tom petty and the heartbreakers ','1976-01-01','American rock band led by singer-songwriter and guitarist Tom Petty.'),(11,'the white stripes ','1997-01-01',' American rock duo comprising Jack White and Meg White known for hits like \"Seven Nation Army\".'),(12,'queen','1970-01-01','British rock band known for hits like \"Don\'t Stop Me Now\" and led by frontman Freddie Mercury.');
...
CREATE TABLE `playlist` (
  ...
  UNIQUE KEY `ID_UNIQUE` (`IDPlaylist`),
  UNIQUE KEY `Name_UNIQUE` (`Name`)
...
INSERT INTO `playlist` VALUES (0,'Isaac\'s Playlist','2023-03-08','Playlist made by Isaac, just basic music.');
...
CREATE TABLE `playlistsong` (
  ...
  UNIQUE KEY `IDPlaylistsong_UNIQUE` (`IDPlaylistsong`),
  KEY `IDSong_idx` (`IDSong`),
  KEY `IDPlaylist_idx` (`IDPlaylist`),
  CONSTRAINT `IDPlaylist` FOREIGN KEY (`IDPlaylist`) REFERENCES `playlist` (`IDPlaylist`),
  CONSTRAINT `IDSong` FOREIGN KEY (`IDSong`) REFERENCES `song` (`IDSong`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `playlistsong` VALUES (7,0,1),(9,0,2),(1,0,3),(11,0,4),(5,0,5);
...
CREATE TABLE `song` (
  ...
  `Single_Release` varchar(10) DEFAULT NULL,
  `File_location` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`IDSong`),
...
INSERT INTO `song` VALUES (0,'we built this city - starship',4.57,'0','Spotify'),(1,'tainted love - soft cell',3.09,'1','Spotify'),(2,'everybody plays the fool - the main ingredient ',3.19,'0','Spotify'),(3,'free bird - lynyrd skynyrd',9.1,'0','Spotify'),(4,'highway to hell - ACDC',3.27,'0','Spotify'),(5,'im still standing - elton john',3.02,'0','Spotify'),(6,'joker and the thief - wolfmother',4.4,'0','Spotify'),(7,'jump - Van Halen',4.01,'0','Spotify'),(8,'mr. blue sky - electric light orchestra',5.02,'0','Spotify'),(9,'runaway baby - bruno mars',2.27,'0','Spotify'),(10,'running down a dream - tom petty',4.2,'1','Spotify'),(11,'seven nation army - the white stripes',3.51,'0','Spotify'),(12,'dont stop me now - the queens',3.29,'0','Spotify');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-03-06 12:22:55',NULL),('diagnostics.include_raw','OFF','2023-03-06 12:22:55',NULL),('ps_thread_trx_info.max_length','65535','2023-03-06 12:22:55',NULL),('statement_performance_analyzer.limit','100','2023-03-06 12:22:55',NULL),('statement_performance_analyzer.view',NULL,'2023-03-06 12:22:55',NULL),('statement_truncate_len','64','2023-03-06 12:22:55',NULL);
...
-- Dump completed on 2023-03-10  9:08:51
